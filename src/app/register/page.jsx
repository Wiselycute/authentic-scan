  ...
  return (
    <section className="relative min-h-screen overflow-x-hidden bg-[#02071F] flex items-center justify-center px-6 py-16">
      ...
      <motion.div
        ...
        className="relative z-10 grid h-150 w-full max-w-4xl overflow-hidden rounded-4xl border border-cyan-500/20 bg-white/5 backdrop-blur-2xl shadow-[0_0_80px_rgba(34,211,238,0.12)] lg:grid-cols-2"
      >
          ...
          <div className="relative z-10">
            ...
            <div className="space-y-2">
              ...
              <p className="max-w-md text-sm leading-relaxed text-slate-400">
                Scan QR codes, analyze packaging, and verify authenticity using
                advanced AI-powered product detection technology.
              </p>
            </div>
          </div>
          ...
          <div className="w-full max-w-md py-2">
            <div className="mb-6">
              ...
              <p className="text-slate-400">
                Join AUTHENTIC SCAN and start detecting fake products.
              </p>
            </div>
            ...
            <p className="mt-6 text-center text-sm text-slate-500">
              ...
              <Link href="/login" className="ml-2 text-cyan-300 hover:text-cyan-200">
                Login
              </Link>
            </p>
          </div>
